package com.fivecode.fiveadmin.utils;
...
public class RedisUtil {
    ...
    @SuppressWarnings({ "unchecked", "null" })
    public long batchZSet(String key, @SuppressWarnings("rawtypes") Set<ZSetOperations.TypedTuple> typles) {
    ...
    @SuppressWarnings("unchecked")
    public void zUnionAndStore(String key, @SuppressWarnings("rawtypes") Collection otherKeys, String destKey) {
